    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>Welcome to my web development portfolio! Explore a collection of projects showcasing my experties in front-end and backend development.</motion.p>
